...
feature_selector = FeatureSelect(df)

feature_selector.correlation_numeric_col(corr_method="pearson")
feature_selector.correlation_numeric_col(df, corr_method="kendall")
feature_selector.correlation_numeric_col(df, corr_method="spearman")

cols_list = ["TotalPerformanceSnapshot", "LeftWheelDiameter", 
             "maxTotalPerformanceSnapshot", "km_till_OMS"]
feature_selector_small = FeatureSelect(data = df[cols_list])

feature_selector_small.corr_standarised_num_col(corr_method="pearson")
feature_selector_small.heat_map()
